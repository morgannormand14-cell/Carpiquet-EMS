        ...
        try:
            ...
            generic_inputs = [
                GenericSystemInput(
                    ...
                    available=hyper_ok,
                    previous_discharge_w=self._twin_prev_hyper_discharge,
                ),
                GenericSystemInput(
                    ...
                    available=solar_ok,
                    previous_discharge_w=self._twin_prev_solar_discharge,
                ),
            ]
            generic = allocate_generic_discharge(
                desired_deficit, generic_inputs, cycle_seconds, ramp
            ).as_dict()
