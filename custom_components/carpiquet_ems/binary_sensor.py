...
from .const import ATTR_GRID_METER_AVAILABLE, ATTR_HYPER_AVAILABLE, ATTR_SOLARFLOW_AVAILABLE, DOMAIN, VERSION
...
async def async_setup_entry(hass, entry, async_add_entities):
    ...
    async_add_entities([CarpiquetHealthSensor(coordinator, entry, *item) for item in HEALTH_ENTITIES])
