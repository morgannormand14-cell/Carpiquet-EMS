    ...
    async def _async_update_data(self):
        try:
            ...
            result_data = {
                ...
                ATTR_ADAPTER_HYPER_PROFILE: adapter.hyper.hardware_plan.control_profile,
                ATTR_ADAPTER_HYPER_PROTOCOL: adapter.hyper.hardware_plan.protocol_generation,
                ATTR_ADAPTER_HYPER_OPERATION: adapter.hyper.hardware_plan.operation,
                ATTR_ADAPTER_HYPER_SERVICE: adapter.hyper.hardware_plan.service,
                ATTR_ADAPTER_HYPER_PAYLOAD: str(adapter.hyper.hardware_plan.payload),
                ATTR_ADAPTER_SOLARFLOW_PROFILE: adapter.solarflow.hardware_plan.control_profile,
                ATTR_ADAPTER_SOLARFLOW_PROTOCOL: adapter.solarflow.hardware_plan.protocol_generation,
                ...
                **transport_policy,
                ...
                ATTR_EXECUTOR_SOLARFLOW_VERIFY_STATE: executor.solarflow_verification.state if executor.solarflow_verification else "NOT_PREPARED",
                ATTR_EXECUTOR_SOLARFLOW_VERIFY_TARGET: executor.solarflow_verification.target if executor.solarflow_verification else "",
                ATTR_EXECUTOR_SOLARFLOW_REPORT_TARGET: executor.solarflow_verification.report_target if executor.solarflow_verification else "",
                ATTR_EXECUTOR_SOLARFLOW_REQUEST_ID: executor.solarflow_verification.request_id if executor.solarflow_verification else "",
                ATTR_EXECUTOR_SOLARFLOW_EXPECTED_OUTPUT: executor.solarflow_verification.expected_output_limit_w if executor.solarflow_verification else 0,
                ATTR_EXECUTOR_SOLARFLOW_POST_STATUS_REQUIRED: executor.solarflow_verification.post_status_required if executor.solarflow_verification else False,
                ATTR_EXECUTOR_SOLARFLOW_REPORT_CONFIRM_REQUIRED: executor.solarflow_verification.report_confirmation_required if executor.solarflow_verification else False,
                ...
                ATTR_LOOP_SIM_REAL_TRANSPORT_USED: (
                    loop_sim_success.real_transport_used
                    or loop_sim_failure.real_transport_used
                    or any(item.real_transport_used for item in loop_sim_degraded)
                ),
                ATTR_LOOP_SIM_DEGRADED_ALL_PASSED: all(item.passed for item in loop_sim_degraded),
