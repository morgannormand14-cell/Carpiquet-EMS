...
SENSORS = [
    ...
    ("command_watchdog_state", "Command Watchdog State", ATTR_COMMAND_WATCHDOG_STATE, None, None),
    ("grid_source_age", "Grid Source Age", ATTR_GRID_SOURCE_AGE, "s", "duration"),
    ("hyper_soc_source_age", "Hyper SOC Source Age", ATTR_HYPER_SOC_SOURCE_AGE, "s", "duration"),
    ("solarflow_soc_source_age", "SolarFlow SOC Source Age", ATTR_SOLARFLOW_SOC_SOURCE_AGE, "s", "duration"),
    ("hyper_pv_source_age", "Hyper PV Source Age", ATTR_HYPER_PV_SOURCE_AGE, "s", "duration"),
    ("solarflow_pv_source_age", "SolarFlow PV Source Age", ATTR_SOLARFLOW_PV_SOURCE_AGE, "s", "duration"),
    ("hyper_output_source_age", "Hyper Output Source Age", ATTR_HYPER_OUTPUT_SOURCE_AGE, "s", "duration"),
    ("solarflow_output_source_age", "SolarFlow Output Source Age", ATTR_SOLARFLOW_OUTPUT_SOURCE_AGE, "s", "duration"),
